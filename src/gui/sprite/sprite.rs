...
impl Sprite {
    ...
    pub fn new_sprite(texture: wgpu::Texture, pos_x: f32, pos_y: f32, path: String) -> Sprite {
        Sprite {
    ...
    pub fn new_with_size(texture: wgpu::Texture, pos_x: f32, pos_y: f32, width: f32, height: f32, path: String) -> Sprite {
        Sprite {
            position: pt2(pos_x, pos_y),
            texture,
